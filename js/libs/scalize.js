    ...
    var scaling = {
        ...
        event : function(elem){
            ...
            $(this.settings.selector).each(function(){
                ...
                $('.toggle', this).hover( function(e){
                    e.preventDefault();
                    $(this).closest(scaling.settings.selector).addClass('active');
                    ...
                    e.preventDefault();
                    $(this).closest(scaling.settings.selector).removeClass('active');
